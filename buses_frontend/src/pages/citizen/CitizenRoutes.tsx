    ...
    <div className="min-h-screen bg-slate-900 text-slate-100">
      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {/* Mapa */}
          <div className="lg:col-span-2 bg-slate-800 rounded-xl border border-slate-700 overflow-hidden" style={{ height: '500px' }}>
            {selectedRoute ? (
              <MapContainer
              ...
              >
                ...
                />
                {/* Dibujar la ruta */}
                {getPolylinePositions(selectedRoute).length > 1 && (
                  <Polyline
                    positions={getPolylinePositions(selectedRoute)}

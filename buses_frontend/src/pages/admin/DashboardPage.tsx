      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <DashboardCard
            ...
            description="Administra asesores para atención al ciudadano"
            color="indigo"
          />
          <DashboardCard
            to="/admin/tickets"
          ...
          <DashboardCard
            ...
            description="Rastrea y audita el historial detallado de todos los viajes realizados en la red."
            color="indigo"
          />
          <DashboardCard
            to="/admin/pqrs"
            ...
            description="Bandeja de entrada para responder y actualizar peticiones, quejas y reclamos."
            color="amber"
          />
          <DashboardCard
            to="/admin/wallet"

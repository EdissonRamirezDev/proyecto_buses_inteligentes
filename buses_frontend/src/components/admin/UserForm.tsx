...
// Schema de creación — password requerido con reglas fuertes
 ...
 * Creación: password requerido con reglas fuertes — HU-ENTR-1-007
 * Edición: password opcional — vacío = no cambia
 * HU-ENTR-1-002
 */
const UserForm = ({ userToEdit, onSuccess, onCancel }: UserFormProps) => {
  ...
  // Precarga los datos del usuario al editar
  useEffect(() => {
    if (userToEdit) {
      reset({
